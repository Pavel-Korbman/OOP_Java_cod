...
public class Program {
    public static void main(String[] args) {
        ...
        if (h instanceof Warrior) {  //  instanceof проверяет принадлежит ли экземпляр h типу Warrior
            ((Warrior) h).attack(null); //  если экземпляр принадлежит типу Warrior, то он применяет метод .attack
        }
        else if (h instanceof Healer) {
            ((Healer) h).healing(null);  //  если экземпляр принадлежит типу Healer, то он применяет метод .healing
        } else {
            //....
        }
        //#endregion
