...
/**
 * Примеры классов, демонстрирующие SOLID
 */
...
class AnimalDatabase {
    public void saveAnimal(Animal animal) {
        // Сохранение данных животного в базу - в отдельном классе
    }
}
...
class Penguin extends Bird {
    ...
    //Пингвины не летают, по этому метод move() - не переопределяется (интерфейс Movable не имплементируем)
}
