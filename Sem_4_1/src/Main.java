...
public class Main {
    public static void main(String[] args) {
        ...
        warenhouse1.addProduct(product1, supplier1);
        warenhouse1.addProduct(product2, supplier2);
        Warenhouse<Tomatoes,BadSupplier> warenhouse2 = new Warenhouse();
        warenhouse2.addProduct(product3, supplier3);
        warenhouse2.addProduct(product4, supplier3);

        System.out.println(warenhouse1);
        System.out.println(warenhouse2);
        System.out.println();

        warenhouse1.delProduct(product1);
        System.out.println(warenhouse1);
    }
}