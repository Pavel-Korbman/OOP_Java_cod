...
/**
 * Здесь создан интерфейс interface ViewDIP, который реализовывают разные вьюеры - ConsoleViewDIP и WinFormViewDIP.
 * Что позволяет их реализовывать не переписывая class BookDIP,
 * а применяя тот или иной вьюер (или оба) в main
 */
